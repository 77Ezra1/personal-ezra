    ...
    <div className="space-y-8">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-slate-300">
          Enter your work email and we&apos;ll send you a secure link to finish setting things up.
        </p>
      </div>
        ...
        <div className="space-y-6 rounded-2xl border border-white/10 bg-white/5 p-8 text-left shadow-lg shadow-slate-950/20">
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-300">
              ...
              <span className="font-semibold text-white">{submittedEmail}</span>. Follow the link when it arrives to
              verify your email.
            </p>
          </div>
